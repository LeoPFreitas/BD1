...
select nome, sexo, datanasc from empregado;
...
select nome, datanasc, sexo, salario from empregado
	where sexo = 'M' and salario between 3000 and 8000 and datanasc >= '1930-01-01' and datanasc <= '1959-12-31';
...
select nome, codigo_ger, salario from empregado
	where salario >= 5000 and codigo_ger in(14,15,19)
